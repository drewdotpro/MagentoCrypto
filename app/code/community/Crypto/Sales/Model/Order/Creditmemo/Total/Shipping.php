 ...
 */
class Crypto_Sales_Model_Order_Creditmemo_Total_Shipping extends Mage_Sales_Model_Order_Creditmemo_Total_Shipping
{
    public function collect(Mage_Sales_Model_Order_Creditmemo $creditmemo)
    {
        ...
        if ($creditmemo->hasBaseShippingAmount()) {
             ...
             */
            if ($baseShippingAmount < Mage::app()->getStore()->roundPrice($baseAllowedAmount) + 0.00000001) {
                /*
